/**
 * Shared report request handler for both Bun server (report-api.ts) and Vercel serverless (api/report.ts).
 * No runtime-specific code — safe to import from Node/Bun.
 */
import {
  openCache,
...
/** Serverless-friendly handler for GET /report and GET /report.json */
